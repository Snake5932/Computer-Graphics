...
void calculateTube(GLfloat **spine) {
    for (int k = -sp; k < sp; k++) {
        ...
        for (int i = 0; i < (n1 + 10); i++) {
            spine[(n1 + 10) * (k + sp) + i][0] = a1 * cosf(angle);
            spine[(n1 + 10) * (k + sp) + i][1] = b1 * sinf(angle);
            spine[(n1 + 10) * (k + sp) + i][2] = lo * angle + 2 * lo * PI * k;
    ...
    for (int k = -sp; k < sp; k++) {
        for (int i = 0; i < (n1 + 10); i++) {
            for (int j = 0; j < (n2 + 10); j++) {
                ...
                vn[0] = polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 0] - spine[mi2][0];
                vn[1] = polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 1] - spine[mi2][1];
                vn[2] = polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 2] - spine[mi2][2];
                normalise(vn);
                ...
                vn[0] = polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 3] - spine[mi1][0];
                vn[1] = polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 4] - spine[mi1][1];
                vn[2] = polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 5] - spine[mi1][2];
                normalise(vn);
                ...
                vn[0] = polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 6] - spine[mi1][0];
                vn[1] = polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 7] - spine[mi1][1];
                vn[2] = polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 8] - spine[mi1][2];
                normalise(vn);
                ...
                vn[0] = polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 0)] - spine[mi2][0];
                vn[1] = polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 1)] - spine[mi2][1];
                vn[2] = polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 2)] - spine[mi2][2];
                normalise(vn);
                ...
                vn[0] = polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 3)] - spine[mi1][0];
                vn[1] = polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 4)] - spine[mi1][1];
                vn[2] = polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 5)] - spine[mi1][2];
                normalise(vn);
                ...
                vn[0] = polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 6)] - spine[mi2][0];
                vn[1] = polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 7)] - spine[mi2][1];
                vn[2] = polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 8)] - spine[mi2][2];
                normalise(vn);
...
void drawEllipses(GLfloat **ellipse, GLfloat **frene) {
    glPushMatrix();
    glMultMatrixf(frene[0]);
    glPointSize(1.0);
    ...
    for (int i = 0; i < (n2 + 10); i++) {
        glNormal3f(0, 0, -1);
        glTexCoord2f(((ellipse[n2 + 9 - i][0] / a2) + 1) / 2, ((ellipse[n2 + 9 - i][1] / b2) + 1) / 2);
        glVertex3f(ellipse[n2 + 9 - i][0],
                   ellipse[n2 + 9 - i][1],
                   ellipse[n2 + 9 - i][2]);
    }
    glNormal3f(0, 0, -1);
    glTexCoord2f(((ellipse[n2 + 9][0] / a2) + 1) / 2, ((ellipse[n2 + 9][1] / b2) + 1) / 2);
    glVertex3f(ellipse[n2 + 9][0],
               ellipse[n2 + 9][1],
               ellipse[n2 + 9][2]);
    glEnd();
    glPopMatrix();
    ...
    glPushMatrix();
    glMultMatrixf(frene[(n1 + 10) * (2 * sp - 1) + n1 + 9]);
    glPointSize(1.0);
    glBegin(GL_TRIANGLE_FAN);
    glNormal3f(0, 0, 1);
    glTexCoord2f(0.5, 0.5);
    ...
    for (int i = 0; i < (n2 + 10); i++) {
        glNormal3f(0, 0, 1);
        glTexCoord2f((ellipse[i][0] / a2 + 1) / 2, (ellipse[i][1] / b2 + 1) / 2);
        glVertex3f(ellipse[i][0],
                   ellipse[i][1],
                   ellipse[i][2]);
    }
    glNormal3f(0, 0, 1);
    glTexCoord2f((ellipse[0][0] / a2 + 1) / 2, (ellipse[0][1] / b2 + 1) / 2);
    glVertex3f(ellipse[0][0],
               ellipse[0][1],
               ellipse[0][2]);
    glEnd();
    glPopMatrix();
...
void drawTube(GLfloat **spine, GLfloat **frene, GLfloat **ellipse, GLfloat *polygons, GLfloat *normals, GLfloat *textures) {
    glPointSize(1.0);
    glBegin(GL_LINE_STRIP);
    for (int k = -sp; k < sp; k++) {
        for (int i = 0; i < (n1 + 10); i++) {
            glVertex3f(spine[(n1 + 10) * (k + sp) + i][0],
                       spine[(n1 + 10) * (k + sp) + i][1],
                       spine[(n1 + 10) * (k + sp) + i][2]);
        }
    }
    glEnd();
    drawEllipses(ellipse, frene);
    float counter1 = 1;
    float step1 = float(4) / (n1 + 10);
    float counter = 0;
    float step = float(1) / (n2 + 10);
    ...
    for (int k = -sp; k < sp; k++) {
        for (int i = 0; i < (n1 + 10); i++) {
            for (int j = 0; j < (n2 + 10); j++) {
                glNormal3f(normals[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 0],
                           normals[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 1],
                           normals[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 2]);
                glTexCoord2f(textures[(n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 0],
                             textures[(n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 1]);
                glVertex3f(polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 0],
                           polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 1],
                           polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 2]);
                glNormal3f(normals[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 3],
                           normals[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 4],
                           normals[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 5]);
                glTexCoord2f(textures[(n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 2],
                             textures[(n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 3]);
                glVertex3f(polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 3],
                           polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 4],
                           polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 5]);
                glNormal3f(normals[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 6],
                           normals[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 7],
                           normals[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 8]);
                glTexCoord2f(textures[(n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 4],
                             textures[(n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 5]);
                glVertex3f(polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 6],
                           polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 7],
                           polygons[(n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 8]);

                int offset = 2 * 9 * sp * (n1 + 10) * (n2 + 10);
                int offset1 = 2 * 6 * sp * (n1 + 10) * (n2 + 10);
                glNormal3f(normals[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 0)],
                           normals[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 1)],
                           normals[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 2)]);
                glTexCoord2f(textures[offset1 + ((n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 0)],
                             textures[offset1 + ((n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 1)]);
                glVertex3f(polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 0)],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 1)],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 2)]);
                glNormal3f(normals[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 3)],
                           normals[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 4)],
                           normals[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 5)]);
                glTexCoord2f(textures[offset1 + ((n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 2)],
                             textures[offset1 + ((n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 3)]);
                glVertex3f(polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 3)],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 4)],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 5)]);
                glNormal3f(normals[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 6)],
                           normals[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 7)],
                           normals[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 8)]);
                glTexCoord2f(textures[offset1 + ((n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 4)],
                             textures[offset1 + ((n2 + 10) * (n1 + 10) * 6 * (k + sp) + (n2 + 10) * 6 * i + j * 6 + 5)]);
                glVertex3f(polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 6)],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 7)],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * 9 * (k + sp) + (n2 + 10) * 9 * i + j * 9 + 8)]);
                counter += step;
            }
            counter1 -= step1;
            counter = 0;
...
void freeN3(GLfloat *polygons, GLfloat *normals, GLfloat *textures) {
    delete[] polygons;
    delete[] normals;
    delete[] textures;
}
...
int main() {
    ...
    auto **spine = new GLfloat*[2 * sp * (n1 + 10)];
    for (int i = 0; i < 2 * sp * (n1 + 10); i++) {
        spine[i] = new GLfloat[3];
    }
    calculateTube(spine);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        drawSystem();
        glMultMatrixf(rModel);
        drawTube(spine, frene, ellipse, polygons, normals, textures);
    ...
    freeN1(spine, frene);
    freeN2(ellipse);
    freeN3(polygons, normals, textures);
    //save();
    return 0;
}