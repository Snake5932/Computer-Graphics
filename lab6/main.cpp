...
void calculatePolygons(GLfloat **ellipse, GLfloat **frene, GLfloat **polygons) {
    for (int k = -sp; k < sp; k++) {
        for (int i = 0; i < (n1 + 10); i++) {
            for (int j = 0; j < (n2 + 10); j++) {
                ...
                multMatrVec(m2, v, vr);
                polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][0] = vr[0];
                polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][1] = vr[1];
                polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][2] = vr[2];
                multMatrVec(m1, v, vr);
                polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][3] = vr[0];
                polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][4] = vr[1];
                polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][5] = vr[2];
                v[0] = ellipse[(j + 1) % (n2 + 10)][0];
                v[1] = ellipse[(j + 1) % (n2 + 10)][1];
                v[2] = ellipse[(j + 1) % (n2 + 10)][2];
                multMatrVec(m1, v, vr);
                polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][6] = vr[0];
                polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][7] = vr[1];
                polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][8] = vr[2];

                v[0] = ellipse[(j) % (n2 + 10)][0];
                v[1] = ellipse[(j) % (n2 + 10)][1];
                v[2] = ellipse[(j) % (n2 + 10)][2];
                int offset = 2 * sp * (n1 + 10) * (n2 + 10);
                multMatrVec(m2, v, vr);
                polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][0] = vr[0];
                polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][1] = vr[1];
                polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][2] = vr[2];
                v[0] = ellipse[(j + 1) % (n2 + 10)][0];
                v[1] = ellipse[(j + 1) % (n2 + 10)][1];
                v[2] = ellipse[(j + 1) % (n2 + 10)][2];
                multMatrVec(m1, v, vr);
                polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][3] = vr[0];
                polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][4] = vr[1];
                polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][5] = vr[2];
                multMatrVec(m2, v, vr);
                polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][6] = vr[0];
                polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][7] = vr[1];
                polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][8] = vr[2];
            }
        }
    }
}
...
void drawTube(GLfloat **spine, GLfloat **frene, GLfloat **ellipse, GLfloat **polygons) {
    glPointSize(1.0);
    ...
    for (int k = -sp; k < sp; k++) {
        for (int i = 0; i < (n1 + 10); i++) {
            for (int j = 0; j < (n2 + 10); j++) {
                ...
                glBegin(GL_POLYGON);
                glNormal3f(polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][0] - spine[m2][0],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][1] - spine[m2][1],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][2] - spine[m2][2]);
                glTexCoord2f(counter, counter1 - step1);
                glVertex3f(polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][0],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][1],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][2]);
                glNormal3f(polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][3] - spine[m1][0],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][4] - spine[m1][1],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][5] - spine[m1][2]);
                glTexCoord2f(counter, counter1);
                glVertex3f(polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][3],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][4],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][5]);
                glNormal3f(polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][6] - spine[m1][0],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][7] - spine[m1][1],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][8] - spine[m1][2]);
                glTexCoord2f(counter + step, counter1);
                glVertex3f(polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][6],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][7],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][8]);
                glNormal3f(polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][0] - spine[m2][0],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][1] - spine[m2][1],
                           polygons[(n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j][2] - spine[m2][2]);
                glTexCoord2f(counter, counter1 - step1);
                ...
                int offset = 2 * sp * (n1 + 10) * (n2 + 10);
                glBegin(GL_POLYGON);
                glNormal3f(polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][0] - spine[m2][0],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][1] - spine[m2][1],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][2] - spine[m2][2]);
                glTexCoord2f(counter, counter1 - step1);
                glVertex3f(polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][0],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][1],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][2]);
                glNormal3f(polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][3] - spine[m1][0],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][4] - spine[m1][1],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][5] - spine[m1][2]);
                glTexCoord2f(counter + step, counter1);
                glVertex3f(polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][3],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][4],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][5]);
                glNormal3f(polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][6] - spine[m2][0],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][7] - spine[m2][1],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][8] - spine[m2][2]);
                glTexCoord2f(counter + step, counter1 - step1);
                glVertex3f(polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][6],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][7],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][8]);
                glNormal3f(polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][0] - spine[m2][0],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][1] - spine[m2][1],
                           polygons[offset + ((n2 + 10) * (n1 + 10) * (k + sp) + (n2 + 10) * i + j)][2] - spine[m2][2]);
                glTexCoord2f(counter, counter1 - step1);
...
void freeN3(GLfloat **polygons) {
    for (int i = 0; i < 4 * sp * (n1 + 10) * (n2 + 10); i++) {
        delete[] polygons[i];
    }
    delete[] polygons;
}
...
int main() {
    ...
    auto **polygons = new GLfloat*[4 * sp * (n1 + 10) * (n2 + 10)];
    for (int i = 0; i < 4 * sp * (n1 + 10) * (n2 + 10); i++) {
        polygons[i] = new GLfloat[9];
    }
    calculatePolygons(ellipse, frene, polygons);
    glMatrixMode(GL_PROJECTION);
    glLoadMatrixf(persp);
    glMatrixMode(GL_MODELVIEW);
    while (!glfwWindowShouldClose(window)) {
        ...
        drawSystem();
        glMultMatrixf(rModel);
        drawTube(spine, frene, ellipse, polygons);
